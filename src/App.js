  ...
  render() {
    return (
      <div className="App">
        ...
        <img src="diary.png" className="title-icon" alt="diary-icon"/>  <div className="page-title"><h1 className="welcome-habit">Welcome to Habit Tracker</h1></div> <img src="diary.png" className="title-icon" alt="diary-icon"/>
        </div>
