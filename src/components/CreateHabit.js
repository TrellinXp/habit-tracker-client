...
export default class CreateHabit extends Component {
    state = { title: "", description: "", amount:"", unit:"", isShowing: false } 
    ...
    handleFormSubmit = (event) => {
        ...
        axios.post("http://localhost:5000/api/habits/",  { title, description, amount, unit, date, user } )
        .then( () => {
        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleFormSubmit}>
                    ...
                    <label>Amount:</label>
                    <textarea name="amount" value={this.state.amount} onChange={ e => this.handleChange(e)} />
                    <label>Unit:</label>
